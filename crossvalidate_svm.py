...
def main():
    ...
    # 2. Define a pipeline with TF-IDF + SVM
    pipeline = Pipeline([
    ...
    print(f"10-fold cross-validation completed. The results have been saved to {cv_csv_filename}\n")
    print(df_cv)
    ...
    # StratifiedKFold splits the dataset into stratified folds
    ...
    plt.title("Confusion Matrix (Summed Over 10 Folds,SVM)")
    plt.colorbar()
    ...
    print("A colorful confusion matrix has been saved as 'confusion_matrix_svm.png'.")
